...
VALUES (1, 'Jan', 'Kowalski', 'jk@gmail.com', '$2a$10$cEcxQ77CzxCh.tNVQH.1r.PXgag9XZj2/glpX2DrnSVdNR3eeZ0yC',
        NULL);
INSERT INTO users (id, first_name, last_name, email, password,  preferred_course_id)
...
VALUES (5, 'Michał', 'Idzik', 'michal.idzik@test.com', '$2a$10$ARcCwjJnygHJw/3hDe2BZO/FHvPXBI.CSs.sjjRW16zkc6oH3TzrC',
         NULL);
INSERT INTO users (id, first_name, last_name, email, password,  preferred_course_id)
VALUES (2, 'admin', 'admin', 'admin@admin.com', '$2a$10$8RfsPIB.mYhx2Qc4HhJKseGDlRJlfgyFktkKWWxCrU6xh5bIvf0Ji',
        NULL);
INSERT INTO users (id, first_name, last_name, email, password,  preferred_course_id)
VALUES (3, 'Kamil', 'Ślimak', 'kamil@snail.com', '$2a$10$V01hVaU8SX30lb083e1UYeH79PkKJg1HC71/WUM1YsUmFHVOKh85e',
        NULL);
INSERT INTO users (id, first_name, last_name, email, password,  preferred_course_id)
...
VALUES (8, 'Jan', 'Kowalski', 'jan.kowalski1@example.com',
        '$2a$12$e/0L6Ob8F5bQK/P4d8lmCuqp6OqPTC4OdOxUPPB6TRhlZcd1fehLy',  NULL),

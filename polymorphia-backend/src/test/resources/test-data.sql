...
INSERT INTO users (id, first_name, last_name, email, password, preferred_course_id)
VALUES (4, 'Sławomir', 'Nowak', 'instructor@agh.com', '$2a$10$k/sZH/gK6qzlLpHw1MqEFOpPXTBi17gdlIs84q2MmevjqsoHWNF4O',null);
...
-- Courses
INSERT INTO courses (id, name, info_url, coordinator_id, coordinator_image_url, instructor_image_url)
VALUES (1, 'Programowanie Obiektowe', '/url', 3, '/coord_url', '/instr_url');

INSERT INTO courses (id, name, info_url, coordinator_id, coordinator_image_url, instructor_image_url)
VALUES (2, 'Programowanie Obiektowe', '/url', 3, '/coord_url', '/instr_url');

INSERT INTO courses (id, name, info_url, coordinator_id, coordinator_image_url, instructor_image_url)
VALUES (3, 'Programowanie Obiektowe', '/url', 4, '/coord_url', '/instr_url');

...
//    public ResponseEntity<List<BaseItemResponseDto>> getItems(@PathVariable Long courseId) {
//        List<BaseItemResponseDto> itemRequestDtos = courseService.getAllCourseItems(courseId);

...
export default function ResetMarkdown({ onClosedAction }: SpeedDialModalProps) {
  const { resetMarkdown, markdownSource} = useMarkdownContext();
  ...
  return (
    ...
    >
      <div className="update-markdown-wrapper">
        <h1>Zresetowanie markdowna usunie wszystkie zmiany i wczyta plik z GitHuba od nowa!</h1>
        <div className="update-markdown-link">
          <h1>Link źródłowy:</h1>
          <a href={markdownSource.sourceUrl} target="_blank" rel="noopener noreferrer">

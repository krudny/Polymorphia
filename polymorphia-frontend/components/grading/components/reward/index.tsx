        ...
        <div className="w-full overflow-y-scroll flex flex-col flex-1 gap-y-4">
            <div className="w-full max-w-sm mx-auto py-3 bg-blue-600 mt-14">
                ...
                {criteria.map((criterion, index) => (
                    <div key={index} className="flex flex-col">
                        ...
                        <div className="grid grid-cols-3 gap-4">
                            {[1,2,3,4,5].map((index) => (
                                <div key={index} className="aspect-square border-3 border-primary-dark rounded-xl flex-col-centered">
                ...
                <div className="w-full my-4">
                    <ButtonWithBorder text="Zapisz" className="w-full !border-3 !rounded-xl"/>
                </div>
            </div>
        </div>
    )

            ...
            <div className="w-full max-w-sm mx-auto py-3 bg-blue-600 mt-14">
                ...
                {pullRequests.map((pullRequest, index) => (
                    <div key={index} className="flex flex-col">
                        ...
                        <h3 className="text-3xl text-secondary-gray hover:cursor-pointer">{pullRequest.url}</h3>
                        <div className="flex gap-x-2 h-fit mt-4">
                        <ButtonWithBorder text="Zapisz" className="w-full !border-3 !rounded-lg !py-1" />
                            <ButtonWithBorder text="Edytuj" className="w-full !border-3 !rounded-lg !py-1" />
                        </div>
                    </div>
                ))}
            </div>
